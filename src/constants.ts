import { AlphabetDescription, AlphabetTransform, AlphabetTextLanguage } from "./types";

export const DEFAULT_TEXTS: Record<AlphabetTextLanguage, string> = {
  "ru": `В тридевятом царстве, в тридесятом государстве жил-был я.
...
Все задумались. Мы сидели на лавках у верхнего дома.`,
  "ka": `რომელმან შექმნა სამყარო ძალითა მით ძლიერითა,
